...
namespace SimpleLib
{
	...
	public static class xSLxOrbwalker
	{
		...
		public static Menu xSLxMenu
		{
		    get
		    {
		        ...
		        var xSLxmenu = new Menu("xSLx OrbWalker", "xSLx");
		        ...
		        xSLxmenu.AddSubMenu(menuDrawing);
		        ...
		        xSLxmenu.AddSubMenu(menuModes);
		        xSLxmenu.AddItem(new MenuItem("xSLx_info", "Copyright by xSLx"));
		        xSLxmenu.AddItem(new MenuItem("xSLx_info2", "Credits: xSLx & Esk0r"));
		...
		private static void OnProcessSpell(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs spell)
		{
			...
			if(unit.IsMe)
			{
				_lastAATick = Environment.TickCount - Game.Ping / 2; // need test 
		...
		private static Obj_AI_Base GetBestHeroTarget()
		{
		    ...
		    switch (SL.CurrentTargetSelector)
		    {
		        case SL.TargetSelector.SimpleTargetSelector:
		            return SimpleTargetSelector.GetTarget(GetAutoAttackRange(), SimpleTargetSelector.DamageType.Physical, SimpleTargetSelector.Team.Enemy);

		        case SL.TargetSelector.CommonTargetSelector:
		            return TargetSelector.GetTarget(GetAutoAttackRange(), TargetSelector.DamageType.Physical);
		    }
		    return TargetSelector.GetTarget(GetAutoAttackRange(), TargetSelector.DamageType.Physical);
		}
	    ...
	    public static void DisablexSLxOrbWalker()
	    {
            Drawing.OnDraw -= OnDraw;
            Game.OnGameUpdate -= OnUpdate;
            Obj_AI_Base.OnProcessSpellCast -= OnProcessSpell;
