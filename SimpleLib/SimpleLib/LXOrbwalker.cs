...
namespace SimpleLib
{
	public static class LXOrbwalker
	{
		...
		public static Menu LxMenu
		{
		    get
		    {
		        ...
		        var LXmenu = new Menu("LX OrbWalker", "LX");
		        ...
		        LXmenu.AddSubMenu(menuModes);
		        LXmenu.AddItem(new MenuItem("lx_info", "Created by Lexxes"));
		...
		private static Obj_AI_Base GetBestHeroTarget()
		{
		    ...
		    switch (SL.CurrentTargetSelector)
		    {
		        case SL.TargetSelector.SimpleTargetSelector:
		            return SimpleTargetSelector.GetTarget(GetAutoAttackRange() + 100, SimpleTargetSelector.DamageType.Physical, SimpleTargetSelector.Team.Enemy);

		        case SL.TargetSelector.CommonTargetSelector:
                    return TargetSelector.GetTarget(GetAutoAttackRange() + 100, TargetSelector.DamageType.Physical);
	    ...
	    public static void DisableLXOrbWalker()
	    {
            Drawing.OnDraw -= OnDraw;
            Game.OnGameUpdate -= OnUpdate;
            Obj_AI_Base.OnProcessSpellCast -= OnProcessSpell;
