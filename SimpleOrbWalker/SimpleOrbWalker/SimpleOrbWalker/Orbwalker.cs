...
namespace SimpleOrbWalker
{
    public class Orbwalker
    {
        ...
        private static void AddToMenu(Menu ConfigMenu) 
        {
            ...
            var menuSTS = new Menu("STS", "Target Selector");
            STS.AddToMenu(menuSTS);
        ...
        {
            if (MenuGUI.IsChatOpen || !Config.Item("Enabled").GetValue<bool>() || Self.IsChanneling) return;

            Orbwalk(GetPossibleTarget(), Game.CursorPos);
        }
    ...
    public interface ICustomOrbwalker
    {
